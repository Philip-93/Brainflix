...
class Home extends React.Component {
  ...
  componentDidMount() {
    // Gettting sidevideo info
    axios
      .get(
        `https://project-2-api.herokuapp.com/videos?api_key=ffb22bc6-6976-404c-9cd6-c366bb70ee9b`
      )
      .then(response => {
        ...
        axios
          .get(
            `https://project-2-api.herokuapp.com/videos/1af0jruup5gu?api_key=ffb22bc6-6976-404c-9cd6-c366bb70ee9b`
          )
          ...
          .then(response => {
            ...
            this.setState({ sideVideos, main: [main], comments, allVideos });
          });
      });
  }
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.match !== this.props.match) {
      axios
        .get(
          `https://project-2-api.herokuapp.com/videos/${this.props.match.params.id}?api_key=ffb22bc6-6976-404c-9cd6-c366bb70ee9b`
        )
        .then(response => {
          const main = response.data;
          const comments = response.data.comments;
